...
//#endregion
//#region node_modules/navigo/lib/navigo.min.js
var require_navigo_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, n) {
		...
		return function() {
			...
			var t = { 407: function(t, n, e) {
				...
				m.if = function(t, n, e) {
					return Array.isArray(n) || (n = [n]), Array.isArray(e) || (e = [e]), [
						t,
						n,
						e
					];
				...
				function x(t, n) {
					var e = 0;
					A(t, (function o() {
						e !== t.matches.length ? m(R, E({}, t, { match: t.matches[e] }), (function() {
							e += 1, o();
						})) : P(t, n);
					}));
				}
...
//#endregion
export default require_navigo_min();
